                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href={{ route ('cliente.ventas')}} class="text-muted">Atrás</a></li>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-actions">
                                                    <div class="text-right">
                                                        ...
                                                        if($boton == "noFirmado"){
                                                        @endphp
                                                        <a href="{{ route('clienteVenta.rechazar',$compraventas->idDocumento) }}" class="btn btn-rounded btn-danger" >Rechazar</a>
                                                        <a href="{{ route('clienteVenta.firmar',$compraventas->idDocumento) }}" class="btn btn-rounded btn-success">Firmar Documento</a>
