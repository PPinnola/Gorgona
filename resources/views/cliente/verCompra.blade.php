                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href={{ route ('cliente.index')}} class="text-muted">Atrás</a></li>
                                        ...
                                        <div class="card-footer" style="background: linear-gradient(90deg, rgba(98,118,233,1) 0%, rgba(128,114,235,1) 45%, rgba(134,113,234,1) 71%);"></div>
                                            ...
                                            <div class="form-actions">
                                                    <div class="text-right">
                                                        ...
                                                        if($boton == "noFirmado"){
                                                        @endphp
                                                        <a href="{{ route('clienteCompra.rechazar',$compraventas->idDocumento) }}" class="btn btn-rounded btn-danger" >Rechazar</a>
                                                        <a href="{{ route('clienteCompra.firmar',$compraventas->idDocumento) }}" class="btn btn-rounded btn-success">Firmar Documento</a>
