            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Mis Ventas</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">Listado de Ventas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        @foreach ($compraventas as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-rounded btn-sm text-white" style="font-size: 12px;background:#61A0FF"  href="{{ route('cliente.verVenta',$item->idDocumento) }}"><i class="fa fa-fw fa-eye"></i> Ver</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
