            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Ver</h4>
                        <div class="d-flex align-items-center">
                             <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href={{route ('conservador.index')}} class="text-muted">Atrás</a></li>
                ...
                <div class="row">
                                ...
                                <div class="tab-pane" id="document1">
                                    ...
                                    <div class="form-actions">
                                            <div class="text-right">
                                                ...
                                                if($boton == "noFirmado"){
                                                @endphp
                                                <a href="{{ route('conservador.rechazar',$compraventas->idDocumento) }}" class="btn btn-rounded btn-danger" >Rechazar</a>
                                                <a href="{{ route('conservador.firmar',$compraventas->idDocumento) }}" class="btn btn-rounded btn-success">Firmar Documento</a>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="card ">
                            <div class="card-header" style="background: linear-gradient(90deg, rgba(98,118,233,1) 0%, rgba(128,114,235,1) 45%, rgba(134,113,234,1) 71%);"></div>
                            <div class="card-body">
                                <p class="text-center"><b>Datos inscripción del documento</b></p>
