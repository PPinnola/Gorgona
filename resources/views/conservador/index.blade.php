            ...
            <nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        <!-- Logo icon -->
                        <a href={{route('conservador.index')}}>
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{asset('images/logoGorgona.jpeg')}}" alt="homepage" style="width: 70%; height: 60%;"/>
                                <!-- Light Logo icon -->
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{ route('conservador.index') }}" aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span class="hide-menu">Compraventas</span></a></li>
                        <li class="list-divider"></li>
                        {{-- <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="index.html"
                            aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
                                class="hide-menu">Mis Compras</span></a></li>
                    <li class="list-divider"></li> --}}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Documentos</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    {{-- <li class="breadcrumb-item text-muted active"><a href="index.html" class="text-muted">Lista de documentos</a></li>  --}}
                                    <li class="breadcrumb-item" aria-current="page">Listado de documentos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="tab-pane" id="document1">
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        @endphp
                                            <tr>
                                                <td>{{ $fecha }}</td>
                                                <td> <span id="estado" class="{{ $color }}"> {{ $estado }}</span></td>
                                                <td><a class="btn btn-rounded btn-sm text-white" style="font-size: 12px;background:#61A0FF" href="{{ route('conservador.ver',$item->idDocumento) }}"><i class="fa fa-fw fa-eye"></i> Ver</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
