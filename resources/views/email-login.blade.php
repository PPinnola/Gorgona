                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #3c69d7; background-image: url('images/heasder-bg.png'); background-repeat: no-repeat; color: #000000; background-size: cover; width: 680px;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1 680px"
                                                    ...
                                                    <div class="border">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    style="width:100%;padding-right:0px;padding-left:0px;padding-top:70px;padding-bottom:70px;">
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img
                                                                            src="{{ $message->embed('home/images/logoblancosinfondo.png') }}"
                                                ...
                                                <td class="column column-1 680px"
                                                    ...
                                                    <div class="border">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    style="text-align:center;width:100%;padding-top:30px;">
                                                                    <h1
                                                                        style="margin: 0; color: #555555; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 34px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img alt="Contacts"
                                                                            ...
                                                                            src="{{ $message->embed('home/images/contacts_no-bg.gif') }}"
                                                ...
                                                <td class="column column-1 680px"
                                                    ...
                                                    <div class="border">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    style="padding-bottom:10px;padding-top:15px;width:100%;text-align:center;">
                                                                    <h3
                                                                        ...
                                                                        <span class="tinyMce-placeholder">Estamos muy
                                                                            felices de anunciar que tu cuenta está creada</span>
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                        ...
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span class="tinyMce-placeholder"
                                                                                    style="font-size:20px;">Tu clave es: {{$clave}}
                                                                                Pero por motivos de seguridad no olvides cambiarla lo más pronto posible</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1 680px"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 50px; padding-right: 50px; vertical-align: top; padding-top: 40px; padding-bottom: 30px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                    width="100%">
                                                    <div class="border">
                                                        <table border="0" cellpadding="20" cellspacing="0"
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px"><img class="big"
                                                                            src="{{ $message->embed('home/images/footer-bg.png') }}"
...
<tbody>
<tr class="reverse">
<td class="column column-1 680px" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 30px; padding-right: 30px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="50%">
<div class="border">
...
<tr>
<td class="pad" style="padding-right:0px;padding-bottom:30px;padding-left:0px;padding-top:20px;">
<div></div>
</td>
</tr>
</table>
...
<td class="column column-2 680px" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 30px; padding-right: 30px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="50%">
<div class="border">
<div class="spacer_block" style="height:75px;line-height:30px;font-size:1px;"> </div>
</div>
</td>
</tr>
</tbody>
                                                                ...
                                                                <td class="column column-1 680px"
                                                                    ...
                                                                    <div class="border">
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td class="pad"
                                                                                    style="vertical-align: middle; padding-bottom: 5px; padding-top: 5px; text-align: center; color: #9d9d9d; font-family: inherit; font-size: 15px;">
                                                                                    <table cellpadding="0"
                                                                                        cellspacing="0"
                                                                                        role="presentation"
                                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
