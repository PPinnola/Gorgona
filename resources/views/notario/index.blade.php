            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Documentos</h4>
                                    ...
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td><a class="btn btn-rounded btn-sm text-white" style="font-size: 12px;background:#61A0FF"  href="{{ route('notario.ver',$item->idDocumento) }}"><i class="fa fa-fw fa-eye"></i> Ver</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
